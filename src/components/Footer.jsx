...
const socialLinks = [
  { icon: <LanguageIcon />, label: 'Website', href: 'https://portfolio-two-tan-eemevqhzoa.vercel.app/' },
  { icon: <EmailIcon />, label: 'Email', href: 'mailto:gauravt9431@gmail.com' },
];
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 6, md: 8 } }}>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }}>
          <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.7)' }}>
            © {new Date().getFullYear()} E-Commerce Platform (by ❤️ Gaurav Tiwari). All rights reserved.
          </Typography>
