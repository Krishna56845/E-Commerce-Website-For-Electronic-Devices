...
const testimonials = [
  {
    ...
    quote: 'Great selection and fast delivery. Highly recommended for quality products.',
  },
  {
    name: 'Morgan Patel',
...
function Home({ products, addToCart, error, loading }) {
  ...
  const bannerImages = [
    ...
    { url: trendingFashionImage, title: 'Trending Products', description: 'Discover the newest trends this season.' },
  ];
    ...
    <Box sx={{ my: { xs: 2, md: 4 } }}>
      ...
      <Container maxWidth="xl">
        ...
        <Box sx={{ mt: 10 }}>
          ...
          <Typography variant="body1" color="text.secondary" textAlign="center" sx={{ mb: 4 }}>
            Real stories from customers who trust our platform.
          </Typography>
          <Grid container spacing={3}>
