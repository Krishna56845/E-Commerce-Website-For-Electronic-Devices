...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Most items include a 1-year manufacturer warranty.',
  },
  {
          ...
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, height: '100%' }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                Call +91-9580561706 from 7 AM – 11 PM IST, 7 days a week. We’ll resolve most issues on the spot.
              </Typography>
            </Stack>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4} id="shipping">
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, height: '100%' }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                Track your order in real time from the Orders dashboard. Text updates available in India.
              </Typography>
            </Stack>
          </Paper>
        </Grid>
