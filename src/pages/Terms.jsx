...
const termsSections = [
  {
    ...
    copy: 'Our platform delivers a digital storefront for quality products. By visiting our site you agree to engage respectfully, refrain from malicious activity, and only submit accurate personal details. Accounts may be suspended when suspicious behaviour is detected.',
    ...
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 10 } }}>
      <Stack spacing={3} alignItems="center" textAlign="center" sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680 }}>
          These terms ensure every order is handled with integrity and care.
        </Typography>
