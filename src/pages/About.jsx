...
const milestones = [
  {
    year: '2018',
    title: 'Launch',
    description: 'Started with a mission to provide quality products and great service.',
  },
  {
    year: '2020',
  ...
  return (
    <Container maxWidth="lg" sx={{ pb: 10 }}>
      <Stack spacing={3} sx={{ textAlign: 'center', mt: 6, mb: 6 }} alignItems="center">
        <Chip label="About Our Platform" color="primary" variant="outlined" sx={{ alignSelf: 'center' }} />
        ...
        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680, mx: 'auto', lineHeight: 1.9, textAlign: 'center' }}>
          Our platform is built by a dedicated team focused on e-commerce excellence. We scout the highest performing products,
